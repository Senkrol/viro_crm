...
class CustomVerification extends Notification
{
    /**
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject(Lang::get('Подтверждение адреса электронной почты')) // тема письма
            ->line(Lang::get('Пожалуйста, нажмите на кнопку ниже, чтобы подтвердить свой адрес электронной почты.'))
            ->action(Lang::get('Подтвердить адрес электронной почты'), $url)
