...
<template>
  ...
  <div class="antialiased bg-gray-100 dark:bg-gray-900 flex h-screen">
    ...
    <div :class="navigationShow ? 'w-72.5' : 'w-0'" class="overflow-hidden duration-300 ease-in-out">
      <aside
        class="left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-viro-main duration-300 ease-linear">
    ...
    <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
      <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow dark:bg-boxdark dark:drop-shadow-none">
        <div class="flex flex-grow items-center justify-between py-2 md:px-6 2xl:px-11 px-4 ">
      ...
      <main class="mx-auto w-full flex flex-1 flex-col p-4 text-black md:p-6 2xl:p-10">
        ...
        <div v-if="$page.props.flash.error" class="p-4 bg-red-400 mb-4 rounded-md w-full">
